...
__decorate([
    ...
    __metadata("design:type", mongoose_2.Types.ObjectId)
], Answer.prototype, "coupleId", void 0);
__decorate([
...
], Answer.prototype, "isRevealed", void 0);
exports.Answer = Answer = __decorate([
    (0, mongoose_1.Schema)({ timestamps: true })
], Answer);
exports.AnswerSchema = mongoose_1.SchemaFactory.createForClass(Answer);
exports.AnswerSchema.index({ questionId: 1, coupleId: 1 });
exports.AnswerSchema.index({ userId: 1 });
exports.AnswerSchema.index({ coupleId: 1 });
exports.AnswerSchema.index({ questionId: 1, userId: 1 }, { unique: true });
